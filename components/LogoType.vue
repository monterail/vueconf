      ...
      <g transform="matrix(1,0,0,1,-3163.82,-1347.75)">
          <g id="vue-conflogo" transform="matrix(0.258594,0,0,0.32375,3163.82,1347.75)">
              ...
              <g transform="matrix(6.40824,0,0,5.11855,-485.016,-963.959)">
                  ...
                  <path :transform="`translate(0, ${typo.f}) rotate(${typo.fR}, 235.128, 289)`" :fill-opacity="typo.fO" d="M237.128,283.256L237.128,285.008L240.416,285.008L240.416,286.7L237.128,286.7L237.128,290L235.1,290L235.1,281.504L240.692,281.504L240.692,283.256L237.128,283.256Z" style="fill:rgb(52,73,95);fill-rule:nonzero;"/>
              </g>
...
export default {
  ...
  methods: {
    ...
    async animateSometimesDesignJustHappens () {
      animate(500, backEaseOut(2), createStep(this.typo, 'fR', 0, 45))
    }
  },
  async mounted () {
    if (process.BROWSER_BUILD) {
      ...
      this.animateDate()
      await wait(1000)
      this.animateSometimesDesignJustHappens()
    }
  }
}
</script>
